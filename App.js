    ...
    <NavigationContainer>
      ...
      >
        <Drawer.Screen name="Home" component={BookStack}
          options = {{
            drawerIcon: ()=> (
              <Image source={{uri:"https://raw.githubusercontent.com/jiafish/hw_w4/master/assets/Icon/untouch/icon_drawer_home.png"}}
              styles={styles.Icon}/>
            )
          }}
        />
        <Drawer.Screen name="MyBook" component={BookStack}
          options = {{
            drawerIcon: ({focused})=> (
              focused
              ?<Image source={{uri:'https://raw.githubusercontent.com/jiafish/hw_w4/master/assets/Icon/touch/icon_drawer_mybook_pressed.png'}} styles={styles.Icon} />
              :<Image source={{uri:'https://raw.githubusercontent.com/jiafish/hw_w4/master/assets/Icon/untouch/icon_drawer_mybook.png'}} styles={styles.Icon} />
            )
          }}
        />
      ...
      <View style={styles.headerContent}>
        ...
        <View style={styles.Content} >
          <View style={styles.textDetail}>
            ...
            <Text style={styles.font}>gdlab2017@gmail.com</Text>
          </View>
